...
namespace Demo
{
    public partial class frmXuatHang : MetroSet_UI.Forms.MetroSetForm
    {
                    ...
                    if (isChecked)
                    {
                        ...
                        if (sp != null)
                        {
                            ...
                            else
                            {
                                ...
                                CustomMessageBox.Show($"Sản phẩm {sp.TenHH} đã hết hàng.");
                            }
                        }
                    }
                }
            ...
            foreach (DataGridViewRow r in dgvPhieuxuat.Rows)
            {
                if (!r.IsNewRow)
                {
                    ...
                    if (kq == null)
                    {
                        ...
                        {
                            CustomMessageBox.Show("Không thể lưu phiếu xuất: " + maPhieuXuat);
                        }
                    }
                }
            }
                ...
                foreach (DataGridViewRow r in dgvCTPhieuXuat.Rows)
                {
                    if (!r.IsNewRow)
                    {
                        ...
                        if (sp2 != null)
                        {
                            ...
                            {
                                CustomMessageBox.Show("Số lượng tồn không đủ để xuất hàng.");
                                return;
                            }
                        }
